  ...
  <tr >
    ...
    <td>
      <video id="vidBack" class="video-js" autoplay muted loop width="400" height="300" data-setup="{}"> 
        ...
        <source src="<?php
          echo "rtmp://".$_SERVER['SERVER_ADDR'].":1931/device/top1";
          ?>" type="rtmp/flv"> 
  ...
  <tr >
    ...
    <tr >
        ...
        <td>
          ...
          <source src="<?php
          echo "rtmp://".$_SERVER['SERVER_ADDR'].":1931/device/back1";
          ?>" type="rtmp/flv"> 
          </video>
         </td>
        <td>&nbsp;</td>
